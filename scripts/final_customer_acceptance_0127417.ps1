...
$Results = Join-Path $Root ("runtime\final-customer-acceptance\" + $stamp)
...
$summary=@("FINAL_CUSTOMER_ACCEPTANCE_PASS","VERSION=$Version","INSTALL_DIR=$InstallDir","BUNDLED_BROWSER=$($browser.FullName)","SLOT1_SHORTCUT=$s1","SLOT2_SHORTCUT=$s2","USER_DATA_PRESERVED=True","RESULTS=$Results")
