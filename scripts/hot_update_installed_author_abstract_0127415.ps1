...
$Backup = Join-Path $Root ("runtime\hotfix-installed-backups\author_abstract_0127415_" + $stamp)
$Results = Join-Path $Root ("runtime\hotfix-results\author_abstract_0127415_" + $stamp)
